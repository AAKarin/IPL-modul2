...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2025 at 01:10 AM
...
ALTER TABLE `order`
  ...
  ADD KEY `IDCutomer` (`IDCustomer`,`IDProduct`),
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_2` FOREIGN KEY (`IDCustomer`) REFERENCES `cutomer` (`IDCustomer`),
  ADD CONSTRAINT `order_ibfk_3` FOREIGN KEY (`IDProduct`) REFERENCES `product` (`IDProduct`);
